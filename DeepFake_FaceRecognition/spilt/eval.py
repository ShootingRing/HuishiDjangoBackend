from DeepFake_FaceRecognition.spilt.data import COCODetection, get_label_map, MEANS, COLORS
from DeepFake_FaceRecognition.spilt.yolact import Yolact
from DeepFake_FaceRecognition.spilt.utils.augmentations import BaseTransform, FastBaseTransform, Resize
from DeepFake_FaceRecognition.spilt.utils.functions import MovingAverage, ProgressBar
from DeepFake_FaceRecognition.spilt.layers.box_utils import jaccard, center_size, mask_iou
from DeepFake_FaceRecognition.spilt.utils import timer
from DeepFake_FaceRecognition.spilt.utils.functions import SavePath
from DeepFake_FaceRecognition.spilt.layers.output_utils import postprocess, undo_image_transformation
import pycocotools

from DeepFake_FaceRecognition.spilt.data import cfg, set_cfg, set_dataset
...
def parse_args(argv=None):
    ...
    parser.add_argument('--trained_model',
                        default='G:\DeepFake_FaceRecognition (3)\DeepFake_FaceRecognition\spilt/weights/yolact_base_54_800000.pth', type=str,
    ...
    parser.add_argument("runserver", default=True, help='视频录制')
...
def evaluate(net:Yolact, dataset,args, name,train_mode=False):
    ...
    if args.image is not None:
        ...
        out="results/{}_split.MP4".format(name)
        inp=args.video
        evalvideo(net, str(inp), out)
        # else:
...
def detect(input,name):
    ...
    with torch.no_grad():
        ...
        evaluate(net, dataset,args,name)
