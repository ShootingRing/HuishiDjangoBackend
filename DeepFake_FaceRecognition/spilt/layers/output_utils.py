...
from DeepFake_FaceRecognition.spilt.data import cfg, mask_type, MEANS, STD, activation_func
from DeepFake_FaceRecognition.spilt.utils.augmentations import Resize
