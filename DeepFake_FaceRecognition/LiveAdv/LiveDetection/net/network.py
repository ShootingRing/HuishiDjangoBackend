...
class BasicConv2d(nn.Module):
    def __init__(self, in_channels, out_channals, style='normal', **kwargs):
        ...
        self.conv_3x1 = nn.Conv2d(out_channals, out_channals, kernel_size=(3, 1), stride=1, padding=(1, 0), bias=False,
                                  **kwargs)
        self.conv_1x3 = nn.Conv2d(out_channals, out_channals, kernel_size=(1, 3), stride=1, padding=(0, 1), bias=False,
                                  **kwargs)
