...
#         self.h_flip = h_flip
#         self.length = len(self.imgs) - SelfBlendedImages
#         if h_flip:
...
#                 trans.Normalize([0.5, 0.5, 0.5], [0.5, 0.5, 0.5])
#             ])
#         self.class_num = self.labels[-SelfBlendedImages] + SelfBlendedImages
        
#     def __len__(self):
#         return self.length
    
#     def __getitem__(self, index):
#         img = torch.tensor(self.imgs[index+SelfBlendedImages], dtype=torch.float)
#         label = torch.tensor(self.labels[index+SelfBlendedImages], dtype=torch.long)
#         if self.h_flip:
